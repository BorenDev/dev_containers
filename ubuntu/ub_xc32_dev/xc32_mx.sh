...
XC32_VERSION=v${XC_TOOLCHAIN_VERSION}
# Location of XC32 4.35.
XC32DIR=/opt/microchip/xc32/$XC32_VERSION
# Where the sources are located.
SRCDIR=/workdir/xc32-${XC32_VERSION}-src/pic32m-source
# Where to store build artifacts.
BUILDDIR=/workdir/xc32-${XC32_VERSION}-src/pic32m-build
...
(
    ...
    make -f ${libmchp_srcdir}/Makefile all -j$(nproc)
...
(
    ...
    ${binutils_srcdir}/configure \
        ...
        --with-pkgversion="Microchip XC32 Compiler ${XC32_VERSION} custom" \
    ...
    make all \
        CPPFLAGS="-I${hostinstalldir}/include -imacros host-defs.h" \
        CFLAGS=-fcommon \
        LDFLAGS=-L${hostinstalldir}/lib -j$(nproc)
...
(
    ...
    cp xc32_device.info ${INSTALLDIR}/bin/xc32_device.info
)
